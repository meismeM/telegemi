...
def help():
    help_text = "Welcome to Gemini 1.5 Pro AI, your intelligent companion powered by Google's cutting-edge technology. Interact seamlessly through text or images, and watch as this Telegram bot responds with insightful answers and engaging conversations. Unlock the power of AI-driven communication with Gemini 1.5 Pro AI – where every message is an opportunity for a smarter exchange. Send text or image!"
