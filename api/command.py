...
def help():
    help_text = "Welcome to Gemini 1.5 Pro AI! Interact through text or images and experience insightful answers. Unlock the power of AI-driven communication – every message is a chance for a smarter exchange. Send text or image! And most importantly join the channels:  [Channel 1](https://t.me/telegemin) and [Channel 2](https://t.me/grade9to12ethiopia). በጀሚኒ 1.5 ፕሮ ኤአይ እንኳን ደህና መጡ! በጽሑፍ ወይም በምስሎች ይገናኙ እና ጠቃሚ መልሶችን ያግኙ። የኤአይ የተነደፈ ግንኙነትን ኃይል ይክፈቱ - እያንዳንዱ መልእክት ለበለጠ ብልህ ልውውጥ እድል ነው። ጽሑፍ ወይም ምስል ይላኩ! እና ከሁሉም በላይ በቻናሎች ይቀላቀሉ።"
